...
def model_prediction(data):
    ...
    y_forecasted = fitted_model.forecast(steps=1)
    return y_forecasted
...
def trading_bot(event=None, context=None):
    ...
    pf_query = """
            SELECT *
            FROM `crypto-prediction-286314.crypto_predictor.tbats_portfolio`
    """
    ...
    pf_data.to_gbq(destination_table='crypto_predictor.tbats_portfolio',
